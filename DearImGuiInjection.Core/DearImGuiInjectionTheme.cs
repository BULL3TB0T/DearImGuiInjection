...
internal static class DearImGuiInjectionTheme
{
    ...
    private static void SetupStyle()
    {
        ...
        colors[(int)ImGuiCol.InputTextCursor] = new(1.00f, 1.00f, 1.00f, 1.00f);
        colors[(int)ImGuiCol.TabHovered] = new(0.27f, 0.27f, 0.27f, 0.86f);
        colors[(int)ImGuiCol.Tab] = new(0.21f, 0.21f, 0.21f, 0.86f);
        colors[(int)ImGuiCol.TabSelected] = new(0.34f, 0.34f, 0.34f, 0.86f);
        colors[(int)ImGuiCol.TabSelectedOverline] = Secondary;
        colors[(int)ImGuiCol.TabDimmed] = new(0.10f, 0.10f, 0.10f, 0.97f);
        colors[(int)ImGuiCol.TabDimmedSelected] = new(0.15f, 0.15f, 0.15f, 1.00f);
        colors[(int)ImGuiCol.TabDimmedSelectedOverline] = new(Secondary.X, Secondary.Y, Secondary.Z, 0.85f);
        colors[(int)ImGuiCol.DockingPreview] = new(Secondary.X, Secondary.Y, Secondary.Z, 0.35f);
        ...
        colors[(int)ImGuiCol.TableHeaderBg] = colors[(int)ImGuiCol.TitleBgActive];
        colors[(int)ImGuiCol.TableBorderStrong] = new(0.38f, 0.38f, 0.38f, 0.80f);
        colors[(int)ImGuiCol.TableBorderLight] = new(0.38f, 0.38f, 0.38f, 0.30f);
        colors[(int)ImGuiCol.TableRowBg] = new(0.00f, 0.00f, 0.00f, 0.00f);
        colors[(int)ImGuiCol.TableRowBgAlt] = new(1.00f, 1.00f, 1.00f, 0.04f);
        colors[(int)ImGuiCol.TextLink] = Secondary;
        colors[(int)ImGuiCol.TextSelectedBg] = new(0.26f, 0.59f, 0.98f, 0.35f);
        colors[(int)ImGuiCol.TreeLines] = new(0.38f, 0.38f, 0.38f, 0.65f);
    ...
    {
        var fontPath = Path.Combine(DearImGuiInjectionCore.AssetsFolderPath, "Fonts", "Comfortaa-Medium.ttf");
        var io = ImGui.GetIO();
        io.Handle->FontDefault = io.Fonts.AddFontFromFileTTF(fontPath, 15);
    }
}
